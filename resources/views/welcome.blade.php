...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{config('app.name','WookieeVet')}}</title>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="{{ asset('images/carousel-main-item-1.jpg') }}" alt="Slide 1">
                </div>
                <div class="item">
                    <img src="{{ asset('images/carousel-main-item-2.jpg') }}" alt="Slide 2">
                </div>
                <div class="item">
                    <img src="{{ asset('images/carousel-main-item-3.jpg') }}" alt="Slide 3">
                </div>
            </div>
